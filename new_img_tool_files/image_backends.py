...
class TextToImageBackend(GradioAutomation, ImageGeneratorBackend):
    ...
    # Space URLs to try in order of preference
    SPACE_URLS = [
        ...
        "https://huggingface.co/spaces/prodia/sdxl-stable-diffusion-xl",
    ]
    
    # Alternative uncensored spaces
    UNCENSORED_SPACE_URLS = [
        "https://huggingface.co/spaces/yodayo-ai/yodayo-diffusion",
        "https://huggingface.co/spaces/cagliostrolab/animagine-xl-3.0",
    ]
...
class ImageToImageBackend(GradioAutomation, ImageGeneratorBackend):
    ...
    SPACE_URLS = [
        "https://huggingface.co/spaces/diffusers/stable-diffusion-xl-img2img",
        "https://huggingface.co/spaces/multimodalart/cosxl",
        "https://huggingface.co/spaces/h1t/ircam",
    ]
...
class InpaintingBackend(GradioAutomation, ImageGeneratorBackend):
    ...
    SPACE_URLS = [
        ...
        "https://huggingface.co/spaces/multimodalart/cosxl-edit",
    ]
...
class UpscaleBackend(GradioAutomation, ImageGeneratorBackend):
    ...
    SPACE_URLS = [
        ...
        "https://huggingface.co/spaces/Kim2091/open-upscaler",
    ]
